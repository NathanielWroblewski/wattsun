...
$(document).ready(function(){
  if ($('#map').length > 0) {
    ...
    $.ajax('http://www.zillow.com/webservice/GetSearchResults.htm' +
      '?zws-id=X1-ZWz1bdsmwbv7yj_963mm' +
      '&address=' + $('#map').data('address') +
      '&citystatezip=' + $('#map').data('zip') + '', {
      dataType: "JSON",
...
$(document).ready(function(){
  ...
  if ($('#map').length > 0) {
    ...
    var myIcon = L.icon({
      iconUrl: "/assets/my_house_marker.png",
      iconSize:     [60, 60],
      iconAnchor:   [30, 30]
    });
    ...
    var solarHomeIcon = L.icon({
      iconUrl: "/assets/solar_home_marker.png",
      iconSize:     [30, 30],
      iconAnchor:   [15, 15]
    });
